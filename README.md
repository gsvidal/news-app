...
`**IMPORTANT: Since May 22, 2020, the API only works in local mode, so in order to use it in production, buying a paid license is required, because of that this project's gh-pages deployed version is not available , just the repository**`
